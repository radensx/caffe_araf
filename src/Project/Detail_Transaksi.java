...
DefaultTableModel model;
    ...
    public Detail_Transaksi() {
        initComponents();
model = new DefaultTableModel(new String[]{"ID Menu", "Nama Menu", "Jumlah", "Subtotal"}, 0);
...
void tampilkanDetail() {
    ...
    try {
        ...
        String sql = "SELECT d.id_menu, m.nama_menu, d.jumlah, d.subtotal " +
                     "FROM transaksi_detail d JOIN menu m ON d.id_menu = m.id_menu " +
                     "WHERE d.id_transaksi = ?";
        PreparedStatement pst = conn.prepareStatement(sql);
        pst.setInt(1, Integer.parseInt(idTransaksi));
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(txtIdTransaksi, javax.swing.GroupLayout.PREFERRED_SIZE, 248, javax.swing.GroupLayout.PREFERRED_SIZE)))
